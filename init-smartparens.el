...
(use-package smartparens
  ...
  ;; (define-key smartparens-mode-map (kbd "C-M-n") 'sp-forward-sexp)
  ...
  ;; (define-key smartparens-mode-map (kbd "C-M-f") 'sp-forward-hybrid-sexp)
  ;; (define-key smartparens-mode-map (kbd "C-M-b") 'sp-backward-hybrid-sexp)
