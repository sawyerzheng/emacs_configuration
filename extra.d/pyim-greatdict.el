...
;; ** 简介
;; pyim-greatdict 是一个pyim 词库， 由[[https://github.com/xiaowl][WenLiang Xiao ]] 同学根据他
;; 之前自己使用的一个NLP 语料库整理而成，这个词库词条比较多，包涵大概330万左右的词条，
;; 文件大小大约80M, 希望可以免去大多数人到处找字典的苦恼。

;; WenLiang Xiao 同学[[https://github.com/tumashu/pyim/pull/77][最初]] 将这个词库通过百度网盘发布，
;; 我个人认为这个词库文件对pyim 很重要，所以为其开启一个项目，并将这个词库命名为：greatdict.

;; ** 安装和使用

;; 1. 配置melpa源，参考：http://melpa.org/#/getting-started
;; 2. Mx package-install RET pyim-greatdict RET
...
;; ** NLP 语料库
;; pyim-greatdict 使用NLP 语料库由[[https://github.com/lshb][刘邵博]] 同学开发，2014 年发布在“中国自然语言开源组织”
;; 的网站，具体网址为：http://www.nlpcn.org/resource/25


;; 语料库的发布包中包含了以下的信息（其中email 地址隐藏）：
...
;; 为了进一步了解相关信息，我给[[https://github.com/lshb][刘邵博]] 同学发了Email 并得到如下回复，确定这个语料库可以自由的使用：
...
;; 我是emacs拼音输入法： pyim 的维护者，https://github.com/tumashu/pyim xiaowl 同学https://github.com/xiaowl 根据你2014 年制作的
;; "词典360万（个人整理）.txt" 为pyim 制作了一个比较好的输入法词库， 由于目前pyim 没有内置词库，所以，我很想将这个词库作为默认pyim 的默认词库来发布， 所以我需要从你这里了解一下“"词典360万（个人整理）.txt"” 的一些信息：
;; 1. "词典360万（个人整理）.txt" 的说明文档中没有说明这个文件使用什么协议发布的， 可不可以明确一下？
;; 2. 你提到这个文件是“综合多个词典整合”，你可以告诉我这些词典的具体信息吗，是开源的词典还是闭源的？
