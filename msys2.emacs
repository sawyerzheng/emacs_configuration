...
(setq cnfonts-directory "~/.conf.d/custom.d/cnfonts/msys2")
;;=========================================================
...
(custom-set-variables
 ...
 '(lsp-pyls-plugins-pycodestyle-ignore '("W191"))
 ...
 '(package-selected-packages
   '(youdao-dictionary company-tabnine http lsp-ui-slideline-mode evil go-eldoc go-autocomplete go-errcheck flycheck-golangci-lint go-snippets go-mode liberime rime yaml-mode mini-modeline cnfonts logview diminish all-the-icons-ivy all-the-icons-ivy-rich all-the-icons-dired all-the-icons doom-modeline imenus imenu-anywhere linum-relative nlinum linum-off htmlize clang-format+ clang-format format-all e2wm edbi eziam-theme zeal-at-point yasnippet-snippets whitespace-cleanup-mode web-mode virtualenvwrapper treemacs-projectile treemacs-magit treemacs-icons-dired treemacs-evil solarized-theme smartparens silkworm-theme realgud rainbow-delimiters pyim org-ac meghanada lsp-java leuven-theme jdecomp ivy-rtags irony highlight-symbol helm-lsp groovy-mode google-c-style flycheck-rtags elpy devdocs dap-mode cyberpunk-theme company-rtags company-c-headers cmake-mode cmake-ide autodisass-java-bytecode))
