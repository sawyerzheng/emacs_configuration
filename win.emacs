...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (cmake-mode zeal-at-point vbasense auto-complete-auctex auctex youdao-dictionary solarized-theme silkworm-theme powershell htmlize geeknote dictionary color-theme avk-emacs-themes auto-complete-clang)))
 '(tool-bar-mode nil))
;(custom-set-faces
